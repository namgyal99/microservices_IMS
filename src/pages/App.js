...
import {FormPage} from './users/AddUsers';
import {ProductPage} from './users/AddProducts';
import RegisterPage from './RegisterPage';
import DetailsPage from './users/AddDetails';
        ...
        <div className={classNames(classes.container, !navDrawerOpen && classes.containerFull)}>
          <Switch>
            ...
            <Route path="/users" component={UserList} />
             <Route path="/add-user" component={FormPage} />
             <Route path="/add-product" component={ProductPage} />
             <Route path="/add-detail" component={DetailsPage} />
